...
export const abandonedCheckout = createTable(
  "abandoned_checkout",
  {
    ...
    customerEmailMarketingConsentMarketingOptInLevel: text(
      "customer_email_marketing_consent_marketing_opt_in_level",
    ),
    customerEmailMarketingConsentMarketingState: text(
      "customer_email_marketing_consent_marketing_state",
    ),
    customerEmailMarketingConsentUpdatedAt: timestamp(
      "customer_email_marketing_consent_updated_at",
    ),
    ...
    // Price sets
    subtotalPriceSetPresentmentMoneyAmount: doublePrecision(
      "subtotal_price_set_presentment_money_amount",
    ),
    subtotalPriceSetPresentmentMoneyCurrencyCode: text(
      "subtotal_price_set_presentment_money_currency_code",
    ),
    subtotalPriceSetShopMoneyAmount: doublePrecision(
      "subtotal_price_set_shop_money_amount",
    ),
    subtotalPriceSetShopMoneyCurrencyCode: text(
      "subtotal_price_set_shop_money_currency_code",
    ),

    totalPriceSetPresentmentMoneyAmount: doublePrecision(
      "total_price_set_presentment_money_amount",
    ),
    totalPriceSetPresentmentMoneyCurrencyCode: text(
      "total_price_set_presentment_money_currency_code",
    ),
    totalPriceSetShopMoneyAmount: doublePrecision(
      "total_price_set_shop_money_amount",
    ),
    totalPriceSetShopMoneyCurrencyCode: text(
      "total_price_set_shop_money_currency_code",
    ),

    totalDiscountSetPresentmentMoneyAmount: doublePrecision(
      "total_discount_set_presentment_money_amount",
    ),
    totalDiscountSetPresentmentMoneyCurrencyCode: text(
      "total_discount_set_presentment_money_currency_code",
    ),
    totalDiscountSetShopMoneyAmount: doublePrecision(
      "total_discount_set_shop_money_amount",
    ),
    totalDiscountSetShopMoneyCurrencyCode: text(
      "total_discount_set_shop_money_currency_code",
    ),

    totalLineItemsPriceSetPresentmentMoneyAmount: doublePrecision(
      "total_line_items_price_set_presentment_money_amount",
    ),
    totalLineItemsPriceSetPresentmentMoneyCurrencyCode: text(
      "total_line_items_price_set_presentment_money_currency_code",
    ),
    totalLineItemsPriceSetShopMoneyAmount: doublePrecision(
      "total_line_items_price_set_shop_money_amount",
    ),
    totalLineItemsPriceSetShopMoneyCurrencyCode: text(
      "total_line_items_price_set_shop_money_currency_code",
    ),

    totalTaxSetPresentmentMoneyAmount: doublePrecision(
      "total_tax_set_presentment_money_amount",
    ),
    totalTaxSetPresentmentMoneyCurrencyCode: text(
      "total_tax_set_presentment_money_currency_code",
    ),
    totalTaxSetShopMoneyAmount: doublePrecision(
      "total_tax_set_shop_money_amount",
    ),
    totalTaxSetShopMoneyCurrencyCode: text(
      "total_tax_set_shop_money_currency_code",
    ),

    totalDutiesSetPresentmentMoneyAmount: doublePrecision(
      "total_duties_set_presentment_money_amount",
    ),
    totalDutiesSetPresentmentMoneyCurrencyCode: text(
      "total_duties_set_presentment_money_currency_code",
    ),
    totalDutiesSetShopMoneyAmount: doublePrecision(
      "total_duties_set_shop_money_amount",
    ),
    totalDutiesSetShopMoneyCurrencyCode: text(
      "total_duties_set_shop_money_currency_code",
    ),
...
export const abandonedCheckoutLine = createTable("abandoned_checkout_line", {
  ...
  // Price ranges
  compareAtPriceRangeMaxVariantCompareAtPriceAmount: doublePrecision(
    "compare_at_price_range_max_variant_compare_at_price_amount",
  ),
  compareAtPriceRangeMaxVariantCompareAtPriceCurrencyCode: text(
    "compare_at_price_range_max_variant_compare_at_price_currency_code",
  ),
  compareAtPriceRangeMinVariantCompareAtPriceAmount: doublePrecision(
    "compare_at_price_range_min_variant_compare_at_price_amount",
  ),
  compareAtPriceRangeMinVariantCompareAtPriceCurrencyCode: text(
    "compare_at_price_range_min_variant_compare_at_price_currency_code",
  ),

  // Discounted price sets
  discountedTotalPriceSetPresentmentMoneyAmount: doublePrecision(
    "discounted_total_price_set_presentment_money_amount",
  ),
  discountedTotalPriceSetPresentmentMoneyCurrencyCode: text(
    "discounted_total_price_set_presentment_money_currency_code",
  ),
  discountedTotalPriceSetShopMoneyAmount: doublePrecision(
    "discounted_total_price_set_shop_money_amount",
  ),
  discountedTotalPriceSetShopMoneyCurrencyCode: text(
    "discounted_total_price_set_shop_money_currency_code",
  ),

  // Original price sets
  originalTotalPriceSetPresentmentMoneyAmount: doublePrecision(
    "original_total_price_set_presentment_money_amount",
  ),
  originalTotalPriceSetPresentmentMoneyCurrencyCode: text(
    "original_total_price_set_presentment_money_currency_code",
  ),
  originalTotalPriceSetShopMoneyAmount: doublePrecision(
    "original_total_price_set_shop_money_amount",
  ),
  originalTotalPriceSetShopMoneyCurrencyCode: text(
    "original_total_price_set_shop_money_currency_code",
  ),

  originalUnitPriceSetPresentmentMoneyAmount: doublePrecision(
    "original_unit_price_set_presentment_money_amount",
  ),
  originalUnitPriceSetPresentmentMoneyCurrencyCode: text(
    "original_unit_price_set_presentment_money_currency_code",
  ),
  originalUnitPriceSetShopMoneyAmount: doublePrecision(
    "original_unit_price_set_shop_money_amount",
  ),
  originalUnitPriceSetShopMoneyCurrencyCode: text(
    "original_unit_price_set_shop_money_currency_code",
  ),
});

// Create Zod schemas for validation
export const insertAbandonedCheckoutSchema =
  createInsertSchema(abandonedCheckout);
export const selectAbandonedCheckoutSchema =
  createSelectSchema(abandonedCheckout);

export const insertAbandonedCheckoutLineSchema = createInsertSchema(
  abandonedCheckoutLine,
);
export const selectAbandonedCheckoutLineSchema = createSelectSchema(
  abandonedCheckoutLine,
);
...
export type NewAbandonedCheckoutLine =
  typeof abandonedCheckoutLine.$inferInsert;
