...
export const productBundle = createTable(
  "product_bundle",
  {
...
export const productBundleComponent = createTable(
...
export const productBundleInventory = createTable(
  "product_bundle_inventory",
  {
    id: bigint("id", { mode: "number" }).primaryKey(),
...
export const insertProductBundleComponentSchema = createInsertSchema(
  productBundleComponent,
);
export const selectProductBundleComponentSchema = createSelectSchema(
  productBundleComponent,
);

export const insertProductBundleInventorySchema = createInsertSchema(
  productBundleInventory,
);
export const selectProductBundleInventorySchema = createSelectSchema(
  productBundleInventory,
);
...
export type NewProductBundleComponent =
  typeof productBundleComponent.$inferInsert;
export type ProductBundleInventory = typeof productBundleInventory.$inferSelect;
export type NewProductBundleInventory =
  typeof productBundleInventory.$inferInsert;
