...
export const stockMovement = createTable(
  ...
  (table) => [
    index("stock_movement_item_location_idx").on(
...
export const inventoryTransfer = createTable(
  "inventory_transfer",
  {
    id: bigint("id", { mode: "number" }).primaryKey(),
...
// Transfer line items
export const inventoryTransferItem = createTable(
...
export const inventoryReservation = createTable(
  ...
  (table) => [
    ...
    index("inventory_reservation_reference_idx").on(
      table.referenceType,
      table.referenceId,
    ),
...
export const inventoryCount = createTable(
  "inventory_count",
  {
    id: bigint("id", { mode: "number" }).primaryKey(),
...
// Count items
export const inventoryCountItem = createTable(
...
export const insertInventoryTransferSchema =
  createInsertSchema(inventoryTransfer);
export const selectInventoryTransferSchema =
  createSelectSchema(inventoryTransfer);

export const insertInventoryTransferItemSchema = createInsertSchema(
  inventoryTransferItem,
);
export const selectInventoryTransferItemSchema = createSelectSchema(
  inventoryTransferItem,
);

export const insertInventoryReservationSchema =
  createInsertSchema(inventoryReservation);
export const selectInventoryReservationSchema =
  createSelectSchema(inventoryReservation);
...
export const insertInventoryCountItemSchema =
  createInsertSchema(inventoryCountItem);
export const selectInventoryCountItemSchema =
  createSelectSchema(inventoryCountItem);
...
export type NewInventoryTransferItem =
  typeof inventoryTransferItem.$inferInsert;
