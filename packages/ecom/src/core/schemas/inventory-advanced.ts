...
export const inventoryBin = createTable(
  "inventory_bin",
  {
    id: bigint("id", { mode: "number" }).primaryKey(),
  ...
  (table) => [
    index("inventory_bin_item_location_idx").on(
...
export const inventorySafetyStock = createTable(
  ...
  (table) => [
    index("inventory_safety_stock_item_location_idx").on(
      table.inventoryItemId,
      table.locationId,
    ),
  ],
...
export const insertLocationCapabilitySchema =
  createInsertSchema(locationCapability);
export const selectLocationCapabilitySchema =
  createSelectSchema(locationCapability);

export const insertInventorySafetyStockSchema =
  createInsertSchema(inventorySafetyStock);
export const selectInventorySafetyStockSchema =
  createSelectSchema(inventorySafetyStock);
