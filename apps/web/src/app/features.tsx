...
const Card = ({
  ...
  return (
    <div
      ...
      className="group/canvas-card relative mx-auto flex h-[18rem] w-full max-w-sm items-center justify-center border border-black/[0.2] p-4 dark:border-white/[0.2]"
    >
