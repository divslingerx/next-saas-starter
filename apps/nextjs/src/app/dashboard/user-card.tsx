...
import { Avatar, AvatarFallback, AvatarImage } from "@charmlabs/ui/avatar";
...
import {
  ...
  CardHeader,
  CardTitle,
} from "@charmlabs/ui/card";
import { Alert, AlertTitle, AlertDescription } from "@charmlabs/ui/alert";
import { Checkbox } from "@charmlabs/ui/checkbox";
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from "@charmlabs/ui/dialog";
import { Input } from "@charmlabs/ui/input";
import { Label } from "@charmlabs/ui/label";
import { PasswordInput } from "@charmlabs/ui/password-input";
import { client, signOut, useSession } from "@charmlabs/core";
...
import {
  ...
  TableHeader,
  TableRow,
} from "@charmlabs/ui/table";
import QRCode from "react-qr-code";
import CopyButton from "@charmlabs/ui/copy-button";
import { Badge } from "@charmlabs/ui/badge";
...
export default function UserCard(props: {
  ...
  const { data: subscription } = useQuery({
    ...
    initialData: props.subscription ?? null,
    queryFn: async () => {
